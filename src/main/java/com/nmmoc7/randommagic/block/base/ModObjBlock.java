 ...
 * @author DustW
 */
public class ModObjBlock extends Block {
    public final BlockItem ITEM;

    public ModObjBlock(String regName, AbstractBlock.Properties properties, ItemGroup group) {
        super(properties);
